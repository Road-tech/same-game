...
### v1.3.0 (2026-06-13)
- ✅ 调整重力和列压缩顺序 — 先重力下坠再列压缩
- ✅ 横竖屏自适应 — 根据设备方向自动交换行列比例
- ✅ 添加音效支持 — 点击消除时播放音效
- ✅ 桌面端鼠标悬停高亮预览 — 移动鼠标预览可消除方块组
- ✅ 修复 Safari 选中效果 — 触摸时不再触发文字/元素选中
- ✅ 修复撤销功能 — 正确回退棋盘状态和分数
- ✅ 优化点击响应 — 使用 mousedown/touchstart 替代 click，消除延迟
- ✅ 添加 PWA 支持 — 可离线运行，支持添加到主屏幕
- ✅ 难度选择改为按钮切换 — 简单/中等/困难一键切换
- ✅ 页面固定不可滚动 — 优化移动端体验
- ✅ 移动端竖屏布局重构 — header 两行布局，按钮自适应
